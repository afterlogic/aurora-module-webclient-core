...
Api.showErrorByCode = function (oResponse, sDefaultError, bNotHide)
{
	...
	{
		default:
			sResultError = sDefaultError || TextUtils.i18n('CORECLIENT/ERROR_UNKNOWN');
			break;
		case Enums.Errors.AuthError:
			sResultError = TextUtils.i18n('CORECLIENT/ERROR_PASS_INCORRECT');
			break;
		case Enums.Errors.DataBaseError:
			sResultError = TextUtils.i18n('CORECLIENT/ERROR_DATABASE');
			break;
		case Enums.Errors.LicenseProblem:
			sResultError = TextUtils.i18n('CORECLIENT/ERROR_INVALID_LICENSE');
			break;
		case Enums.Errors.DemoLimitations:
			sResultError = TextUtils.i18n('CORECLIENT/INFO_DEMO_THIS_FEATURE_IS_DISABLED');
			break;
		case Enums.Errors.Captcha:
			sResultError = TextUtils.i18n('CORECLIENT/ERROR_CAPTCHA_IS_INCORRECT');
			break;
		case Enums.Errors.CanNotGetMessage:
			sResultError = TextUtils.i18n('CORECLIENT/ERROR_MESSAGE_DELETED');
			break;
		case Enums.Errors.NoRequestedMailbox:
			sResultError = sDefaultError + ' ' + TextUtils.i18n('CORECLIENT/ERROR_INVALID_ADDRESS', {'ADDRESS': (oResponse.Mailbox || '')});
			break;
		case Enums.Errors.CanNotChangePassword:
			sResultError = TextUtils.i18n('CORECLIENT/ERROR_UNABLE_CHANGE_PASSWORD');
			break;
		case Enums.Errors.AccountOldPasswordNotCorrect:
			sResultError = TextUtils.i18n('CORECLIENT/ERROR_CURRENT_PASSWORD_NOT_CORRECT');
			break;
		...
		case Enums.Errors.MailServerError:
			sResultError = TextUtils.i18n('CORECLIENT/ERROR_CANT_CONNECT_TO_SERVER');
			break;
		case Enums.Errors.DataTransferFailed:
			sResultError = TextUtils.i18n('CORECLIENT/ERROR_DATA_TRANSFER_FAILED');
			break;
